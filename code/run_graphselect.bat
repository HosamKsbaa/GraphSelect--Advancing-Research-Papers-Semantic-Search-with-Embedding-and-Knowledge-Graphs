...
REM =============================================================================
REM  GraphSelect — One-Click Docker Launcher (Windows)
REM  Usage:
REM    run_graphselect.bat           Start the application
REM    run_graphselect.bat --stop    Stop and remove containers
REM =============================================================================
...
REM ── 3. Gather environment variables ──────────────────────────────────────────
set "GEMINI_API_KEY="
set "OPENALEX_EMAIL="

REM Try to load existing .env file
if exist "%ENV_FILE%" (
...
REM Use PowerShell to check health endpoint silently
